...
char  *inet_srcrt_init(void);
void	 inet_srcrt_print(char *, int);
char   **my_addrs(int *);
...
int		 mcast_join(int, const SA *, socklen_t, const char *, int);
int		 mcast_get_if(int);
int		 mcast_get_loop(int);
int		 mcast_get_ttl(int);
int		 mcast_set_if(int, const char *, int);
int		 mcast_set_loop(int, int);
int		 mcast_set_ttl(int, int);

void	 Mcast_leave(int, const SA *, socklen_t);
void	 Mcast_join(int, const SA *, socklen_t, const char *, int);
int		 Mcast_get_if(int);
int		 Mcast_get_loop(int);
int		 Mcast_get_ttl(int);
void	 Mcast_set_if(int, const char *, int);
...
long	 Sysconf(int);
void	 Sysctl(int *, int, void *, size_t *, void *, size_t);
